package cn.zcyoung.home.utils.mail;
...
public class SimpleMailSender {  
	...
	public static boolean SendCodeMail(String toMail, String url){
		try{
			MailSenderInfo mailInfo = new MailSenderInfo();  
			mailInfo.setMailServerHost("smtp.163.com");  
			mailInfo.setMailServerPort("25");  
			mailInfo.setValidate(true);  
			mailInfo.setUserName("zcyoung_admin@163.com");  
			mailInfo.setPassword("zcyoung123");// 您的邮箱密码  
			mailInfo.setFromAddress("zcyoung_admin@163.com");  
			String[] to = {toMail};  
			...
			mailInfo.setSubject("来自zcyoung的邮件验证");  
			String body = "亲，<a href='"+url+"'>"+"点击这里</a>进行激活，五分钟内有效。【来自：zcyoung】";  
	...
	public static boolean SendMail(String toMail, String body, String title){
		try{
			MailSenderInfo mailInfo = new MailSenderInfo();  
			mailInfo.setMailServerHost("smtp.163.com");  
			mailInfo.setMailServerPort("25");  

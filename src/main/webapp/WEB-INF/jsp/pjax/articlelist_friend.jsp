...
<title>${friend.nickname }的文章列表-ZCYOUNG 年轻人</title>
<c:if test="${msg!=null }">
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">${friend.nickname }的文章列表</h3>
	</div>
</div>
<div style="text-align:right;">
	<form data-pjax action="/article/friend/${friend.username }" method="post">
...
<div class="pagination pagination-centered">
	<ul>
			<li><a data-pjax href="/article/friend/${friend.username}/1/${Key}">&lt;&lt;</a></li>
			<li><a data-pjax href="/article/friend/${friend.username}/${Page.pageIndex-1 }/${Key}">&lt;</a></li>
			...
			<c:forEach var="item" varStatus="vs" begin="1" end="5">
				...
				<li><a data-pjax href="/article/friend/${friend.username}/${now }/${Key}">
					<c:if test="${Page.pageIndex == now }"><strong><b><u>${now }</u></b></strong></c:if> 
					<c:if test="${Page.pageIndex != now }">${now }</c:if>
				</a></li>
			</c:forEach>
			<li><a data-pjax href="/article/friend/${friend.username}/${Page.pageIndex+1 }/${Key}">&gt;</a></li>
			<li><a data-pjax href="/article/friend/${friend.username}/${Page.totalPages }/${Key}">&gt;&gt;</a></li>
		</ul>
	<br>
	<br>
</div>
